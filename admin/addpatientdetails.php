...
$sql="insert into addpatientdetail (name,bloodtype,age,phone,hospitalname,location) value 
('$name','$bloodtype','$age','$phone','$hospitalname','$location')";
        ...
        <div class="card-body">
          <form method="POST" action="">
            <div class="form-group">
              ...
              <input class="form-control" name="name" id="exampleInputEmail1" type="text" aria-describedby="emailHelp" placeholder="Enter Patient Name" autocomplete="off">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control" name="age" id="exampleInputPassword1" type="text" placeholder="Patient Age" autocomplete="off">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Patient Phone Number</label>
              <input class="form-control" name="phone" id="exampleInputPassword1" type="tel" placeholder="Patient Phone Number" autocomplete="off">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Hospital Name</label>
              <input class="form-control" name="hospitalname" id="exampleInputPassword1" type="text" placeholder="Hospital Name" autocomplete="off">
            </div>
            <div class="form-group">
              ...
              <input class="form-control" name="location" id="exampleInputPassword1" type="text" placeholder="Detail Hospital Location" autocomplete="off">
                        ...
                        <button type="submit" class="form-control" id="cf-submit" name="submit" onclick="myFunction()">Add</button>
          </form>
