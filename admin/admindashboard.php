...
<?php 
$connect1 = mysqli_connect("localhost", "root", "", "bloodmanagement");
$query = "SELECT * FROM addpatientdetail";
$result = mysqli_query($connect1, $query);
$chart_data = '';
while($row = mysqli_fetch_array($result))
{
 $chart_data .= "{ bloodtype:'".$row["bloodtype"]."', age:".$row["age"]."}, ";
}
...
<?php  
$connect = mysqli_connect("localhost", "root", "", "bloodmanagement");  
$query = "SELECT bloodtype, count(*) as number FROM addpatientdetail GROUP BY bloodtype";  
      ...
      <div class="card mb-3">
        <div class="card-header">
         <div style="width:500px;">  
          <h3 align="center">Data Analysis of Blood-Type Required..</h3>  
          <br />  
          <div id="piechart" style="width: 700px; height: 450px;"></div>
          <h3 align="center">Analysis of Age group with that of the Blood Group.</h3>
