	...
	function map_initialize()
	{
		...
		map = new google.maps.Map(document.getElementById("google_map"), googleMapOptions);			
			...
			google.maps.event.addListener(map, 'rightclick', function(event) {
				...
				'<label for="pDesc"><span>Phone Number :</span><input type="text" name="pDesc" class="save-desc" placeholder="Enter Phone number" maxlength="40"></label>'+
				'<label for="pType"><span>Blood Type :</span> <select name="pType" class="save-type"><option value="A+">A+</option><option value="A-">A-</option>'+
				'<option value="B+">B+</option>'+
				'<option value="B+">B-</option>'+
				'<option value="AB+">AB+</option>'+
				'<option value="AB-">AB-</option>'+
				'<option value="O+">O+</option>'+
				'<option value="O-">O-</option></select></label>'+
				'</form>'+
				'</div></p><button name="save-marker" class="save-marker">Add Personal Details.</button>';
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-4">
					<div class="footer-thumb"> 
						<h4 class="wow fadeInUp" data-wow-delay="0.4s">Add Personal Informations here</h4>
						<li>Here, Blue marker represents location of Donor.</li>
						<li>Right Click on the Map to view form.</li>
						<li>Add personal Informations there.</li>
						<li>Blue Marker Represents the position of the donor.</li>
						<li>Click on the blue marker and View the details of the Donor.</li>
						<li>Make appointment for the donation with the suitable and nearby donor.</li>
					</div>
				</div>
