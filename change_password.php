...
<body>
    <form name="frmChange" method="post" action=""
        ...
        <div style="width: 500px;">
            ...
            <table border="0" cellpadding="10" cellspacing="0"
                width="500" align="center" class="tblSaveForm" style="color:red;">
                <tr class="tableheader">
                    <td style="color:black;">Change Password</td>
                </tr>
                <tr>
 ...
 <tr>
                    <td colspan="2"><a href="userdashboard.php"><input type="button" name=""
                        value="Back" class="btnSubmit"></a></td>
                </tr>
            </table>
        </div>
    </form>
